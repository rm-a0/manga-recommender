...
from manga_recommender.ingestion.loader import sync_genres_for_manga
...
def test_sync_genres_for_manga_attaches_genres(db_session: Session) -> None:
    ...
    sync_genres_for_manga(db_session, manga, ["Action", "Adventure"])
...
def test_sync_genres_for_manga_normalizes_names(db_session: Session) -> None:
    ...
    sync_genres_for_manga(db_session, manga, [" Dark Fantasy ", "DARK FANTASY"])
...
def test_sync_genres_for_manga_does_not_duplicate_existing_genres(
    ...
    sync_genres_for_manga(db_session, manga, ["Action"])

    sync_genres_for_manga(db_session, manga, ["Action", "Drama"])
